   ...
   void calculate_goal()
    {
        ...
        if (t1_found && t2_found) {
            ...
            // ... (Rest of your calculation code: creating pose, publishing, etc.) ...
            
            RCLCPP_INFO(this->get_logger(), ">>> FINAL GOAL: [x: %.2f, y: %.2f] <<<", mid_x, mid_y);
            
            // goal_calculated_ = true; // Uncomment this if you only want it calculated once
        }
    } 
};
